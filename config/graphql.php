...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'variables' => Expressionengine\Coilpack\Api\Graph\Queries\VariablesQuery::class,
            ],
            'mutation' => [
    ...
    'types' => [
        'Category' => Expressionengine\Coilpack\Api\Graph\Types\Category::class,
        'Channel' => Expressionengine\Coilpack\Api\Graph\Types\Channel::class,
        'ChannelEntry' => Expressionengine\Coilpack\Api\Graph\Types\ChannelEntry::class,
